const projects = {
  vocaplace: {
    ...
    about: (
      <div id="about">
        <p>
          <span className="bold">VocaPlace</span> is a dynamic web application
          designed to facilitate English learning and foster a collaborative
          community environment. Drawing inspiration from popular platforms such
          as Memrise and Duolingo, the app offers users an immersive and
          engaging learning experience.
        </p>
        <br />
        <p>
          This full-stack application was developed as a collaborative effort by
          a three-person team, with a primary focus on utilizing{' '}
          <span className="color bold">React.js</span> for its front-end
          architecture and seamlessly integrating it with{' '}
          <span className="color bold">Node.js</span> and{' '}
          <span className="color bold">PostgreSQL</span> back-end.
        </p>
      </div>
    ),
    features: (
  ...
  'wings-of-fire': {
    ...
    roblox:
      'https://www.roblox.com/games/3618661625/Wings-of-Fire-Early-Access',
    logo: 'https://github.com/oworob/roblox-screenshots/blob/main/wings-of-fire/wof-logo.png?raw=true',
    about: (
      <div id="about">
        <p>
          <span className="bold">Wings of Fire</span> is a series of fantasy
          novels by Tui. T. Sutherland, taking place on the two fictional,
          dragon-inhabited continents of Pyrrhia and Pantala. Each novel takes
          the reader on a thrilling adventure of various twists and turns,
          following a lovable cast of characters.{' '}
        </p>
        <br />
        <p>
          The game is a loose adaptation of the books developed by a small team
          on <span className="color bold">Roblox</span> over the last couple of
          years, that allows players to create their characters, complete
          quests, decorate houses and roleplay in the world of dragons.
        </p>
      </div>
    ),
    features: (
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Emotes, actions and movement cycles, including walking, flying
                and swimming
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li>
                Acquiring character accessories by completing in-game quests
              </li>
            </ul>
          </li>
          <li>
  ...
  twitter: {
    ...
    about: (
      <div id="about">
        <p>
          <span className="bold">Twitter</span> is a social media platform that
          allows users to share short messages. It serves as a real-time
          microblogging platform where users can post updates, thoughts, news,
          and engage in conversations with others and is used by millions of
          users across the world.
        </p>
        <br />
        <p>
          This project, also called 'Y' is a full-stack application with the
          goal to recreate a simple version of the platform. It was written with
          the aim to learn <span className="color bold">Vue.js</span> and{' '}
          <span className="color bold">Socket.io</span>.
        </p>
      </div>
    ),
    features: (
      <div id="features">
        <ul>
          ...
          <li>
            Profile customization, including profile picture and a short bio
          </li>
          <li>
            Following users
            <ul>
  ...
  'restaurant-orders': {
    ...
    about: (
      <div id="about">
        <p>
          Create your perfect order - choose your favorite dishes and customize
          them with a variety of extras.
        </p>
        <br />
        <p>
          This project is a small application written in{' '}
          <span className="color bold">Spring Boot</span> using{' '}
          <span className="bold color">Thymeleaf</span> that allows users to
          place orders in a fictional restaurant. The menu consisting of
          multiple meals with a list of available extras is imported using
          beans.
        </p>
      </div>
    ),
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                Customization of each meal by adding one or more of available
                extras
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>
                Meal manager that allows the user to manage meals by changing
                their price, name and category
              </li>
  ...
  deviantart: {
    ...
    about: (
      <div id="about">
        <p>
          <span className="bold">DeviantArt</span> is an online platform and
          community that serves as a showcase for artists of various mediums,
          including visual arts, photography, literature, and digital creations.
          It provides a space for artists to exhibit their work, connect with
          other creatives, and receive feedback from a global audience.
        </p>
        <br />
        <p>
          This project is a full-stack application aimed at recreating the
          platform from scratch. It was undertaken with the goal of learning
          technologies like <span className="color bold">React.js</span>,{' '}
          <span className="color bold">Express</span>,{' '}
          <span className="color bold">Neo4j</span>,{' '}
          <span className="color bold">Keycloak</span>, and{' '}
          <span className="color bold">Docker</span>.
        </p>
      </div>
    ),
    features: (
      <div id="features">
        <ul>
          ...
          <li>
            Submitting and managing images, including description and tags
          </li>
          <li>Adding images to favourites</li>
          <li>Posting comments under images</li>
          <li>
            User profile customization, including profile picture, background
